...
def post_help_bot(room_id, token):
    message = "This is how you can interact with me: \n\n"
    ...
    message += "Remember to always tag me at the beginning of message otherwise I won't know who you're talking to!!"
    #<br/>Buzzing Regards,<br/>Cap'n Buzz"
